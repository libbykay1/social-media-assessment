...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<TweetResponseDto> reverseChronological(List<TweetResponseDto> tweets) {
	...
	public UserResponseDto createNewUser(UserRequestDto userRequestDto) {
		...
		if (!validateService.validateUsernameAvailable(username)) {
	...
	public UserResponseDto getUserByUsername(String username) {
		return userMapper.entityToDto(getUserEntity(username));
	}
	...
	public UserResponseDto deleteUser(String username, CredentialsDto credentials) {
		...
		if (!validateService.validateCredentialsExist(username, userCredentials.getPassword())) {
	...
	public void unfollow(CredentialsDto credentialsDto, String username) {
		...
		User credUser = userRepository
				.findByCredentialsUsernameAndCredentialsPasswordAndDeletedFalse(credUsername, credPassword).get();
